...
\newcommand{\handout}[5]{
   ...
   \framebox{
      \vbox{
    \hbox to 6.1in { {\bf Advanced Algorithms 2021}
     	 \hfill #2 }
       \vspace{5mm}
       \hbox to 6.1in { {\Large \hfill #5  \hfill} }
       \vspace{6mm}
       \hbox to 6.1in { {\it #3 \hfill #4} }
      }
   }
   \end{center}
   \vspace*{4mm}
...
\newcommand{\syllabusstyle}[3]{
   ...
   \framebox{
      \vbox{
    \hbox to 5.78in { {\bf Advanced Algorithms}
     	 \hfill #1 }
       \vspace{4mm}
...
\newcommand{\exercise}[4]{\handout{#1}{#2}{Lecturer: #3}{Student Name: #4}{#1}}

\newcommand{\solution}[4]{\handout{#1}{#2}{Lecturer: #3}{Teaching Assistang: #4}{Sample Solutions #1}}
